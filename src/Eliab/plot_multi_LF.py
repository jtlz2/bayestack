...
def main():
    ...
    chains=['02a_z_8x_6_1','02b_z_8x_6_1','02c_z_8x_6_1','02d_z_8x_6_1','02e_z_8x_6_1','02f_z_8x_6_1','02g_z_8x_6_1','02h_z_8x_6_1','02i_z_8x_6_1','02j_z_8x_6_1']#fixed cut data more bins _el lmin lose
    ...
    chains2=['01a','01b','01c','01d','01e','01f','01g_1_2','01h','01i','01j'] #dpl #chains_2011 DR4 newz new_area
    chains=['02a_z_8x_6_1','02b_z_8x_6_1','02c_z_8x_6_1','02d_z_8x_6_1','02e_z_8x_6_1','02f_z_8x_6_1','02g_z_8x_6_3','02h_z_8x_6_3','02i_z_8x_6_3','02j_z_8x_6_5']#fixed cut data more bins new photoz
    #chains=['02a','02b','02c','02d','02e','02f','02g','02h','02i','02j'] #lgnorm #chains_2011 DR4 newz new_area
    
    chains3='02z_31_3' #Novak evolution fit
    chains3='02z_31_5_15' #Fixed evolution newz, area
    chains3='02z_31_5_15' #Fixed evolution newz, area new photoz
    ...
    #dpl  = 
     ...
     #   family='LFdpl_dpl',inta=None,area=0,S=0, z=z_m, dlds=0,Vmax=0,dl=0) for lL in bins3]
     #sys.exit()
     ...
     plt.fill_between(lin_xrecon+hm,numpy.log10((yrecon_d))-dm,numpy.log10(yrecon_u) -dm, color='b',label=r'$\rm{95\%}$ $\rm{Model}$ $\rm{C}$ $\rm{Individual}$' ,alpha=0.27)
     ...
     plt.errorbar(bins3+hm,numpy.log10(faint)-dm,fmt='-.b' ,linewidth=3,label=r'$\rm{SFG}$ $\rm{MAP}$ $\rm{Model}$ $\rm{C}$ $\rm{Individual}$')
     ...
     plt.errorbar(numpy.log10(10**bins3), numpy.log10(phi_tot_n),fmt='--k',linewidth=3,label=r'$\rm{Total}$ $\rm{Novak+2018}$')
