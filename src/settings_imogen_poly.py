...
#dataset='video'
binStyle=7
nlaws=2 #no. of coeffs for poly, no. power-laws for ppl
floatNoise=False
modelFamily='poly'#'ppl' 'poly' 'bins'
outdir='chains_150608a' # based on 140123a
...
P0=1.0
P1=1.0
simParams=[SMIN_SIM,SMAX_SIM,P0,P1]
simParamsList=['S0','S1','p0','p1']
...
SEED_SIM=1234
NSIM=2000#374995 # sources in 1 sq deg of skads
NOISE_SIM=21.0 # uJy
dump='R.txt'
output='dummy.txt'
verbose=True
...
#    perGalGalaxyType='sbn'
    ...
    if useInjectedMap:
        ...
        perGalRadioMap=='/Users/imogen/src/bayestack/fake_map/VLA-VVDS-1.4GHZ.FITS'
...
if context=='u' or context == 'i':
    ...
    injectInputMap='/Users/imogen/src/bayestack/fake_map/VLA-VVDS-1.4GHZ.FITS'
...
if context=='i' or True:
    ...
    injectionNoise=NOISE_SIM*8.9# This is the scaling factor between pixel noise and map noise - find by looking at noise in simulated map with no sources # 48.0240 is for NOISE_SIM=16.2 uJy - need to figure this out!
